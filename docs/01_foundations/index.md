...
| **[04 Decoupled Workflow](04_decoupled_workflow.md)** | Scheduled batch, volumetric, and drift-driven ingestion trigger patterns that protect training compute. |
| **[05 Closed Loops Guardrails](05_closed_loop_guardrails.md)** | Data contract and guardrails to protect the continuous training process. |